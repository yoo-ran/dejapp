...
export default function Onboarding({ navigation }) {
  return (
    <View style={styles.container}>
      {/* ImageBackground component to display a background image */}
      <ImageBackground
        style={styles.backgroundImage}
        source={require('../assets/onboarding.jpg')} 
      >
        <View style={styles.bg}>
          {/* Container for the heading text and logo, aligned at the bottom */}
          ...
          {/* Container for description text and button, aligned at the bottom */}
